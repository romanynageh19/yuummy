...
function disPlay(){
   ...
   for (let i = 0; i < data.length; i++) {
      temp+=`<div class="col-3  g-3">
          ...
          <img category="${data[i].strCategory}" class="w-100 bg-black" src="${data[i].strCategoryThumb}">
            
          <h3 class="color-dark">${data[i].strCategory  }</h3>
  ...
  cartona=""
   for (let i = 0; i < data.length; i++) {
      ...
      <div  class="test col-3 g-3">
          ...
          <img  id= "${cate[i].idMeal} " class="w-100 bg-danger-subtle test" src="${cate[i].strMealThumb}">
            
          <h3 id= ${cate[i].idMeal}  class="color-dark">${cate[i].strMeal  }</h3>
